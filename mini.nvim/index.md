...
For easier exploration, here they are presented in groups based on module's primary functionality (although some modules can fit in several groups). See more detailed listing [here](doc/mini-nvim.qmd).
...
| mini.cmdline   | Command line tweaks                      | [README](readmes/mini-cmdline.md)   | [Documentation](doc/mini-cmdline.qmd)   |
...
| mini.statuscolumn  | Statuscolumn                           | [README](readmes/mini-statuscolumn.md)  | [Documentation](doc/mini-statuscolumn.qmd)  |
