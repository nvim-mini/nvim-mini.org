...
See more details in [Features](#features) and [Documentation](../doc/mini-notify.qmd).
...
![](https://github.com/nvim-mini/assets/blob/main/demo/demo-notify.mp4?raw=true)
...
- Custom `vim.notify()` implementation. To adjust, use [`MiniNotify.make_notify()`](../doc/mini-notify.qmd#mininotify.make_notify) after calling `setup()`.

- Automated show of LSP progress report.

- Track history which can be accessed with [`MiniNotify.get_all()`](../doc/mini-notify.qmd#mininotify.get_all) and shown with [`MiniNotify.show_history()`](../doc/mini-notify.qmd#mininotify.show_history).
