...
- Various textobject specifications for ['mini.ai'](https://nvim-mini.org/mini.nvim/readmes/mini-ai). See [`:h MiniExtra.gen_ai_spec`](../doc/mini-extra.qmd#miniextra.gen_ai_spec).

- Various highlighters for ['mini.hipatterns'](https://nvim-mini.org/mini.nvim/readmes/mini-hipatterns). See [`:h MiniExtra.gen_highlighter`](../doc/mini-extra.qmd#miniextra.gen_highlighter).
