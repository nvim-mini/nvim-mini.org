...
See more details in [Features](#features) and [Documentation](../doc/mini-pairs.qmd).
...
- Usage should be through making appropriate mappings using [`MiniPairs.map()`](../doc/mini-pairs.qmd#minipairs.map) or in [`MiniPairs.setup()`](../doc/mini-pairs.qmd#minipairs.setup) (for global mapping), [`MiniPairs.map_buf()`](../doc/mini-pairs.qmd#minipairs.map_buf) (for buffer mapping).
