...
See more details in [Features](#features) and [Documentation](../doc/mini-ai.qmd).
...
- Customizable creation of `a`/`i` textobjects using Lua patterns and functions. Supports:
    - Dot-repeat.
    - `v:count`.
    - Different search methods (see [`:h MiniAi.config`](../doc/mini-ai.qmd#miniai.config)).
    - Consecutive application (update selection without leaving Visual mode).
    - Aliases for multiple textobjects.
- Comprehensive builtin textobjects (see more at [`:h MiniAi-builtin-textobjects`](../doc/mini-ai.qmd#miniai-builtin-textobjects)):
...
- Set of specification generators to tweak some builtin textobjects (see
  help for [`MiniAi.gen_spec`](../doc/mini-ai.qmd#miniai.gen_spec)).
- Treesitter textobjects (through [`MiniAi.gen_spec.treesitter()`](../doc/mini-ai.qmd#miniai.gen_spec.treesitter) helper).
...
-- No need to copy this inside `setup()`. Will be used automatically.
{
  ...
  -- For more information with examples see, [`:h MiniAi.config`](../doc/mini-ai.qmd#miniai.config).
  custom_textobjects = {},
