...
- Tweaking built-in maps for "LSP kind" to include icons. In particular, this makes ['mini.completion'](https://nvim-mini.org/mini.nvim/readmes/mini-completion) use icons in LSP step. See [`:h MiniIcons.tweak_lsp_kind()`](../doc/mini-icons.qmd#miniicons.tweak_lsp_kind).
