...
See more details in [Features](#features) and [Documentation](../doc/mini-cursorword.qmd).
...
![](https://github.com/nvim-mini/assets/blob/main/demo/demo-cursorword.mp4?raw=true)
