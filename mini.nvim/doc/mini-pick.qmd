...
- Interactive query matching (filter+sort) with fast non-blocking default
  which does fuzzy matching and allows other modes ([MiniPick.default\_match()](mini-pick.qmd#minipick.default_match)).
...
- [vim.ui.select()](https://neovim.io/doc/user/helptag.html?tag=vim.ui.select\(\)) implementation. To adjust, use [MiniPick.ui\_select()](mini-pick.qmd#minipick.ui_select)
...
- Out of the box support for ['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') and ['smartcase'](https://neovim.io/doc/user/helptag.html?tag='smartcase').
...
- [MiniPick-in-other-plugins](mini-pick.qmd#minipick-in-other-plugins) (for plugin authors)
...
- <a name="minipick-cli-tools" href="mini-pick.qmd#minipick-cli-tools"><b>MiniPick-cli-tools</b></a> CLI tool(s) to power [MiniPick.builtin.files()](mini-pick.qmd#minipick.builtin.files),
  [MiniPick.builtin.grep()](mini-pick.qmd#minipick.builtin.grep), and [MiniPick.builtin.grep\_live()](mini-pick.qmd#minipick.builtin.grep_live) built-in pickers:
...
- [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim):
    ...
    - Has many built-in pickers, while this module has handful at its core
      relying on other [mini.nvim](mini-nvim.qmd#mini.nvim) modules to provide more (see [mini.extra](mini-extra.qmd#mini.extra)).
...
<a name="minipick-hl-groups" href="mini-pick.qmd#minipick-hl-groups"><b>MiniPick-hl-groups</b></a>
...
<a name="minipick-in-other-plugins" href="mini-pick.qmd#minipick-in-other-plugins"><b>MiniPick-in-other-plugins</b></a>


- Prefer using [vim.ui.select()](https://neovim.io/doc/user/helptag.html?tag=vim.ui.select\(\)) for more user coverage. Use [MiniPick.start()](mini-pick.qmd#minipick.start)
...
### Events {#minipick-events .help-syntax-right-anchor}
...
### Overview {#minipick-overview .help-syntax-right-anchor}
...
- Type characters to filter and sort matches. It uses [MiniPick.default\_match()](mini-pick.qmd#minipick.default_match)
...
### Source {#minipick-source .help-syntax-right-anchor}
...
- `nil`. Picker waits for explicit [MiniPick.set\_picker\_items()](mini-pick.qmd#minipick.set_picker_items) call.
...
out of the box with [MiniPick.default\_show()](mini-pick.qmd#minipick.default_show), [MiniPick.default\_preview()](mini-pick.qmd#minipick.default_preview),
...
- `query` - array of strings. Usually (like is common case of user interactively
  ...
  allowed, as query can be set with [MiniPick.set\_picker\_query()](mini-pick.qmd#minipick.set_picker_query).

It should either return array of match indexes for stritems elements matching
the query (synchronous) or explicitly use [MiniPick.set\_picker\_match\_inds()](mini-pick.qmd#minipick.set_picker_match_inds)
...
- Both `stritems` and `query` depend on values of ['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') and ['smartcase'](https://neovim.io/doc/user/helptag.html?tag='smartcase').
  If query shows "ignore case" properties (only ['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') is set or both
  ['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') / ['smartcase'](https://neovim.io/doc/user/helptag.html?tag='smartcase') are set and query has only lowercase characters),
...
Default value is [MiniPick.default\_match()](mini-pick.qmd#minipick.default_match).
...
Default value is [MiniPick.default\_show()](mini-pick.qmd#minipick.default_show).
...
Default value is [MiniPick.default\_preview()](mini-pick.qmd#minipick.default_preview).
...
- It is called when picker window is still current. Use `windows.target` value
  from [MiniPick.get\_picker\_state()](mini-pick.qmd#minipick.get_picker_state) output to do something with target window.
...
Default value is [MiniPick.default\_choose()](mini-pick.qmd#minipick.default_choose).
...
Default value is [MiniPick.default\_choose\_marked()](mini-pick.qmd#minipick.default_choose_marked).

---

### Actions {#minipick-actions .help-syntax-right-anchor}
...
- `mappings.delete_left` - delete everything to the left (like [i\_CTRL-U](https://neovim.io/doc/user/helptag.html?tag=i_CTRL-U)).

- `mappings.delete_word` - delete word to the left (like [i\_CTRL-W](https://neovim.io/doc/user/helptag.html?tag=i_CTRL-W)).
...
- Supports special cases of register: <span class="help-syntax-keys">\<C-f\></span> (as [c\_CTRL-R\_CTRL-F](https://neovim.io/doc/user/helptag.html?tag=c_CTRL-R_CTRL-F)),
  <span class="help-syntax-keys">\<C-w\></span> (as [c\_CTRL-R\_CTRL-W](https://neovim.io/doc/user/helptag.html?tag=c_CTRL-R_CTRL-W)), <span class="help-syntax-keys">\<C-a\></span> (as [c\_CTRL-R\_CTRL-A](https://neovim.io/doc/user/helptag.html?tag=c_CTRL-R_CTRL-A)),
  <span class="help-syntax-keys">\<C-l\></span> (as [c\_CTRL-R\_CTRL-L](https://neovim.io/doc/user/helptag.html?tag=c_CTRL-R_CTRL-L)).
...
- Pasting from system [clipboard](https://neovim.io/doc/user/helptag.html?tag=clipboard) is supported for "non-streaming" paste (as
  described in [vim.paste()](https://neovim.io/doc/user/helptag.html?tag=vim.paste\(\))). Use terminal's key combo instead of this action.
...
- Perform consecutive "narrowing" queries. Example: to get items that contain
  ...
  matching, type `'hello` (notice `'` at the start) followed by <span class="help-syntax-keys">\<C-Space\></span> and
  another `'world`.
...
### Examples {#minipick-examples .help-syntax-right-anchor}
...
following (expanded, [expandcmd()](https://neovim.io/doc/user/helptag.html?tag=expandcmd\(\))) [<span class="help-syntax-keys">\<f-args\></span>](https://neovim.io/doc/user/helptag.html?tag=<f-args>) combined in a single table.
...
See [MiniPick.ui\_select()](mini-pick.qmd#minipick.ui_select).
...
- Current window at the moment of this function call is treated as "target".
  ...
  See [MiniPick.get\_picker\_state()](mini-pick.qmd#minipick.get_picker_state) and [MiniPick.set\_picker\_target\_window()](mini-pick.qmd#minipick.set_picker_target_window).
...
`(table|nil)` Depending on whether computation is synchronous (either `opts.sync`
  ...
  - If no, `nil` is returned with [MiniPick.set\_picker\_match\_inds()](mini-pick.qmd#minipick.set_picker_match_inds) used later.
...
match is done with [MiniPick.default\_match()](mini-pick.qmd#minipick.default_match)). Lines are computed based on
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible values:
  ...
  - <span class="help-syntax-keys">\<n_context_lines\></span> `(number)` - number of lines to load past target position
    when reading from disk. Useful to explore context. Default: ['lines'](https://neovim.io/doc/user/helptag.html?tag='lines') twice.
...
Implements default value for [MiniPick-source.choose\_marked](mini-pick.qmd#minipick-source.choose_marked).
...
[mini.pick](mini-pick.qmd#mini.pick) for any "select" type of tasks.
...
- Allows `opts.preview_item` that returns one of:
    ...
    - Preview data described in [vim.ui.select()](https://neovim.io/doc/user/helptag.html?tag=vim.ui.select\(\)) (on Neovim>=0.12.3).
...
To customize CLI tool search, either use tool's global configuration approach
or directly [MiniPick.builtin.cli()](mini-pick.qmd#minipick.builtin.cli) with specific command.
Options ['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') and ['smartcase'](https://neovim.io/doc/user/helptag.html?tag='smartcase') are respected via forcing appropriate
...
<span class="help-syntax-special">{local_opts}</span> `(table|nil)` Options defining behavior of this particular picker.
  ...
  - <span class="help-syntax-keys">\<pattern\></span> `(string)` - string pattern to search. If not given, asks user
    interactively with [MiniInput.get()](mini-input.qmd#miniinput.get) (if enabled) or [input()](https://neovim.io/doc/user/helptag.html?tag=input\(\)).
  ...
  - <span class="help-syntax-keys">\<method\></span> `(string)` - pattern matching method: `"regex"` (default) or `"plain"`.
...
matching. Use <span class="help-syntax-keys">\<C-o\></span> to restrict search to files matching glob patterns.
Use <span class="help-syntax-keys">\<C-e\></span> to change pattern matching method. Tries to use one of the CLI
tools to create items (see [MiniPick-cli-tools](mini-pick.qmd#minipick-cli-tools)): `rg`, `git`. If none is
...
<span class="help-syntax-special">{local_opts}</span> `(table|nil)` Options defining behavior of this particular picker.
  ...
  - <span class="help-syntax-keys">\<globs\></span> `(table)` - array of string glob patterns to restrict search to
    ...
    specific glob syntax and effects. Default: `{}` (no restriction).
    Example: `{ '*.lua', 'lua/**' }` for Lua files and files in "lua" directory.
    Use <span class="help-syntax-keys">\<C-o\></span> custom mapping to add glob to the array. It uses [MiniInput.get()](mini-input.qmd#miniinput.get)
    (if enabled) to show input in ['winbar'](https://neovim.io/doc/user/helptag.html?tag='winbar') or ['statusline'](https://neovim.io/doc/user/helptag.html?tag='statusline') (depending of
    whether content is from bottom).

  - <span class="help-syntax-keys">\<method\></span> `(string)` - pattern matching method: `"regex"` (default) or `"plain"`.
    Use <span class="help-syntax-keys">\<C-e\></span> custom mapping to add glob to the array.
...
Uses [MiniPick.set\_picker\_items\_from\_cli()](mini-pick.qmd#minipick.set_picker_items_from_cli).
...
[MiniPick.set\_picker\_items()](mini-pick.qmd#minipick.set_picker_items) and [MiniPick.set\_picker\_items\_from\_cli()](mini-pick.qmd#minipick.set_picker_items_from_cli)
...
`(table|nil)` Picker config (`opts` table of [MiniPick.start()](mini-pick.qmd#minipick.start)) or `nil` if
  no active picker.
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<querytick\></span> `(number|nil)` - value of querytick ([MiniPick.get\_querytick()](mini-pick.qmd#minipick.get_querytick))
...
[MiniPick.get\_picker\_items()](mini-pick.qmd#minipick.get_picker_items) and [MiniPick.get\_picker\_stritems()](mini-pick.qmd#minipick.get_picker_stritems)
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<set_items_opts\></span> `(table)` - table forwarded to [MiniPick.set\_picker\_items()](mini-pick.qmd#minipick.set_picker_items).
...
- Inside custom asynchronous [MiniPick-source.match](mini-pick.qmd#minipick-source.match) function to set which of
  picker's stritems match the query. See [MiniPick.poke\_is\_picker\_active()](mini-pick.qmd#minipick.poke_is_picker_active).

- To programmatically set current match and marked items.
  See [MiniPick.get\_picker\_matches()](mini-pick.qmd#minipick.get_picker_matches).
...
[MiniPick.get\_picker\_matches()](mini-pick.qmd#minipick.get_picker_matches)
...
[MiniPick.get\_picker\_opts()](mini-pick.qmd#minipick.get_picker_opts)
...
[MiniPick.get\_picker\_state()](mini-pick.qmd#minipick.get_picker_state)
...
See [MiniPick.poke\_is\_picker\_active()](mini-pick.qmd#minipick.poke_is_picker_active) for usage example.
...
Returns an output of [MiniPick.is\_picker\_active()](mini-pick.qmd#minipick.is_picker_active), but depending on
