...
- Preconfigured ways of computing jump spots (see [MiniJump2d.builtin\_opts](mini-jump2d.qmd#minijump2d.builtin_opts)):
...
- Jump to line start using combination of options supplied in
  [MiniJump2d.config](mini-jump2d.qmd#minijump2d.config) and [MiniJump2d.builtin\_opts.line\_start](mini-jump2d.qmd#minijump2d.builtin_opts.line_start):
...
- See more examples in [MiniJump2d.start()](mini-jump2d.qmd#minijump2d.start) and [MiniJump2d.builtin\_opts](mini-jump2d.qmd#minijump2d.builtin_opts).
...
- [phaazon/hop.nvim](https://github.com/phaazon/hop.nvim):
    ...
    - Both have several builtin ways to specify type of jump (word start,
      ...
      customization with Lua code (see [MiniJump2d.builtin\_opts](mini-jump2d.qmd#minijump2d.builtin_opts)).
    ...
    - [mini.jump2d](mini-jump2d.qmd#mini.jump2d) has opinionated default algorithm of computing jump
      spots. See [MiniJump2d.default\_spotter()](mini-jump2d.qmd#minijump2d.default_spotter).

#### Highlight groups {#module-highlightgroups}


<a name="minijump2d-hl-groups" href="mini-jump2d.qmd#minijump2d-hl-groups"><b>MiniJump2d-hl-groups</b></a>
...
- `MiniJump2dSpot` - highlighting of jump spot's next step. By default it
  ...
  white on black for dark ['background'](https://neovim.io/doc/user/helptag.html?tag='background'), black on white for light. If it
...
"temporary current" (see [nvim\_win\_call()](https://neovim.io/doc/user/helptag.html?tag=nvim_win_call\(\))). This allows using builtin
...
jump spots (like, for example, [MiniJump2d.builtin\_opts.word\_start](mini-jump2d.qmd#minijump2d.builtin_opts.word_start)).
...
<span class="help-syntax-special">{pattern}</span> `(string|nil)` Vimscript [pattern](https://neovim.io/doc/user/helptag.html?tag=pattern). Default: `\k\+` to match group
  of "keyword characters" (see ['iskeyword'](https://neovim.io/doc/user/helptag.html?tag='iskeyword')).
...
(like in [MiniJump2d.builtin\_opts.line\_start](mini-jump2d.qmd#minijump2d.builtin_opts.line_start)).
...
Jump with [MiniJump2d.default\_spotter()](mini-jump2d.qmd#minijump2d.default_spotter)
...
Respects ['iskeyword'](https://neovim.io/doc/user/helptag.html?tag='iskeyword') when computing word start.
