...
<a name="ministatusline-hl-groups" href="mini-statusline.qmd#ministatusline-hl-groups"><b>MiniStatusline-hl-groups</b></a>
...
`(string)` String suitable for ['statusline'](https://neovim.io/doc/user/helptag.html?tag='statusline').
...
If [mini.git](mini-git.qmd#mini.git) is not set up, section falls back on `lewis6991/gitsigns.nvim` data
...
If [mini.diff](mini-diff.qmd#mini.diff) is not set up, section falls back on `lewis6991/gitsigns.nvim` data
or showing empty string.
...
Shows ['filetype'](https://neovim.io/doc/user/helptag.html?tag='filetype'), ['fileencoding'](https://neovim.io/doc/user/helptag.html?tag='fileencoding') / ['encoding'](https://neovim.io/doc/user/helptag.html?tag='encoding'), ['fileformat'](https://neovim.io/doc/user/helptag.html?tag='fileformat'), and buffer size.
Short output has only non-empty ['filetype'](https://neovim.io/doc/user/helptag.html?tag='filetype') and is returned if window width is
lower than `args.trunc_width` or buffer is not normal (as per ['buftype'](https://neovim.io/doc/user/helptag.html?tag='buftype')).
