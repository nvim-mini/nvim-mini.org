...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<deepcopy\></span> - (boolean) Whether to create a copy of tables in <span class="help-syntax-special">{state}</span>.
...
<span class="help-syntax-special">{text_width}</span> `(number|nil)` Number of editable columns resized window will
  display. Default: first element of ['colorcolumn'](https://neovim.io/doc/user/helptag.html?tag='colorcolumn') or otherwise ['textwidth'](https://neovim.io/doc/user/helptag.html?tag='textwidth')
...
File should have a recognized file type (see ['filetype'](https://neovim.io/doc/user/helptag.html?tag='filetype')) and be opened in
a normal buffer (see ['buftype'](https://neovim.io/doc/user/helptag.html?tag='buftype')).

Note: it relies on file mark data stored in ['shadafile'](https://neovim.io/doc/user/helptag.html?tag='shadafile') (see [shada-f](https://neovim.io/doc/user/helptag.html?tag=shada-f)).
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<ignore_filetype\></span> - Array with file types to be ignored (see ['filetype'](https://neovim.io/doc/user/helptag.html?tag='filetype')).
...
This works by parsing ['commentstring'](https://neovim.io/doc/user/helptag.html?tag='commentstring') buffer option, extracting
non-whitespace comment leader (symbols on the left of commented line), and
locally modifying ['comments'](https://neovim.io/doc/user/helptag.html?tag='comments') option (by prepending `n:<leader>`). Does
nothing if ['commentstring'](https://neovim.io/doc/user/helptag.html?tag='commentstring') is empty or has comment symbols both in front
and back (like `/*%s*/`).
...
Note: for most filetypes ['commentstring'](https://neovim.io/doc/user/helptag.html?tag='commentstring') option is added only when buffer
