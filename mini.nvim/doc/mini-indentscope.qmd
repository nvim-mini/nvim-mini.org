...
- Customization of scope computation options can be done on global level
  ...
  `opts` variable in [MiniIndentscope.get\_scope()](mini-indentscope.qmd#miniindentscope.get_scope)).
...
- [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim):
    ...
    - Implementation of [mini.indentscope](mini-indentscope.qmd#mini.indentscope) is similar to
...
<a name="miniindentscope-hl-groups" href="mini-indentscope.qmd#miniindentscope-hl-groups"><b>MiniIndentscope-hl-groups</b></a>


- `MiniIndentscopeSymbol` - symbol showing on every line of scope if its
  indent is multiple of ['shiftwidth'](https://neovim.io/doc/user/helptag.html?tag='shiftwidth').

- `MiniIndentscopeSymbolOff` - symbol showing on every line of scope if its
  indent is not multiple of ['shiftwidth'](https://neovim.io/doc/user/helptag.html?tag='shiftwidth').
...
### Drawing {#miniindentscope-drawing .help-syntax-right-anchor}
...
Field `n_lines` defines [MiniIndentscope.get\_scope()](mini-indentscope.qmd#miniindentscope.get_scope) behavior for how many
...
<span class="help-syntax-special">{scope}</span> `(table|nil)` Scope. Default: output of [MiniIndentscope.get\_scope()](mini-indentscope.qmd#miniindentscope.get_scope)
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Currently supported:
   ...
   - <span class="help-syntax-keys">\<animation_fun\></span> - animation function for drawing. See
     [MiniIndentscope-drawing](mini-indentscope.qmd#miniindentscope-drawing) and [MiniIndentscope.gen\_animation](mini-indentscope.qmd#miniindentscope.gen_animation).

   - <span class="help-syntax-keys">\<priority\></span> - priority number for visualization. See `priority` option
     for [nvim\_buf\_set\_extmark()](https://neovim.io/doc/user/helptag.html?tag=nvim_buf_set_extmark\(\)).
...
<span class="help-syntax-special">{scope}</span> `(table|nil)` Scope to use. Default: output of [MiniIndentscope.get\_scope()](mini-indentscope.qmd#miniindentscope.get_scope).
