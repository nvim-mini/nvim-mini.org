...
- [junegunn/vim-easy-align](https://github.com/junegunn/vim-easy-align):
    ...
    - [mini.align](mini-align.qmd#mini.align) is mostly designed after `junegunn/vim-easy-align`, so
    ...
    - Both plugins allow users to change alignment options interactively by
      ...
      `junegunn/vim-easy-align` has those modifiers fixed, while [mini.align](mini-align.qmd#mini.align)
    ...
    - `junegunn/vim-easy-align` is designed to treat delimiters differently
      than other parts of strings. [mini.align](mini-align.qmd#mini.align) doesn't distinguish split
    ...
    - `junegunn/vim-easy-align` initially aligns by only first delimiter.
      [mini.align](mini-align.qmd#mini.align) initially aligns by all delimiter.

    - `junegunn/vim-easy-align` implements special filtering by delimiter
      row number. [mini.align](mini-align.qmd#mini.align) has builtin filtering based on Lua code
    ...
    - [mini.align](mini-align.qmd#mini.align) treats any non-registered modifier as a plain delimiter
      pattern, while `junegunn/vim-easy-align` does not.

    - [mini.align](mini-align.qmd#mini.align) exports core Lua function used for aligning strings
...
- [godlygeek/tabular](https://github.com/godlygeek/tabular):
    ...
    - `godlygeek/tabular` is mostly designed around single command which is
      customized by printing its parameters. [mini.align](mini-align.qmd#mini.align) implements
    ...
    - `godlygeek/tabular` can detect region upon which alignment can be
      desirable. [mini.align](mini-align.qmd#mini.align) does not by design: use Visual selection or
...
There are two main processes implemented in [mini.align](mini-align.qmd#mini.align): strings alignment
...
- Visual blockwise selection works best with ['virtualedit'](https://neovim.io/doc/user/helptag.html?tag='virtualedit') equal to "block"
  or "all".

- Alignment with preview works best with ['showmode'](https://neovim.io/doc/user/helptag.html?tag='showmode') disabled.
...
<span class="help-syntax-special">{exclude_comment}</span> `(boolean|nil)` Whether to add comment pattern to
  `split_exclude_patterns`. Comment pattern is derived from ['commentstring'](https://neovim.io/doc/user/helptag.html?tag='commentstring')
  option. Default: `true`.
