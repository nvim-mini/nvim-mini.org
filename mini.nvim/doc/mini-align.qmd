...
#### Comparisons {#minialign-comparisons}
...
- [junegunn/vim-easy-align](https://github.com/junegunn/vim-easy-align):
    ...
    - 'junegunn/vim-easy-align' implements special filtering by delimiter
      ...
      supplied by user in modifier phase. See [`MiniAlign.gen_step.filter()`](mini-align.qmd#minialign.gen_step.filter)
    ...
    - 'mini.align' exports core Lua function used for aligning strings
      ([`MiniAlign.align_strings()`](mini-align.qmd#minialign.align_strings)).
...
### Glossary {#minialign-glossary}

#### PARTS {#minialign-glossary-parts}


2d array of strings (array of arrays of strings).
See more in [`MiniAlign.as_parts()`](mini-align.qmd#minialign.as_parts).
...
A named callable. See [`MiniAlign.new_step()`](mini-align.qmd#minialign.new_step). When used in terms of alignment
...
Main implementation is in [`MiniAlign.align_strings()`](mini-align.qmd#minialign.align_strings). Its input is array of
...
- Default main steps are designed to be controlled via options. See
  [`MiniAlign.align_strings()`](mini-align.qmd#minialign.align_strings) and default step entries in [`MiniAlign.gen_step`](mini-align.qmd#minialign.gen_step).
...
### Modifiers builtin {#minialign-modifiers-builtin}
...
<span class="help-syntax-keys">\<f\></span> Enter filter expression. See more details in [`MiniAlign.gen_step.filter()`](mini-align.qmd#minialign.gen_step.filter).
...
<span class="help-syntax-keys">\<i\></span> Ignore some split matches. It modifies `split_exclude_patterns` option by
  ...
  [`MiniAlign.gen_step.ignore_split()`](mini-align.qmd#minialign.gen_step.ignore_split).
...
For more details about options see [`MiniAlign.align_strings()`](mini-align.qmd#minialign.align_strings) and entries of
[`MiniAlign.gen_step`](mini-align.qmd#minialign.gen_step) for default main steps.
...
### align_strings() {#minialign.align_strings}
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Its copy will be passed to steps as second
  ...
  For more information see [`MiniAlign.gen_step`](mini-align.qmd#minialign.gen_step) entry for corresponding
  default step.
...
<span class="help-syntax-special">{steps}</span> `(table|nil)` Steps. Extended with `MiniAlign.config.steps`.
  ...
  - `split` - [`MiniAlign.gen_step.default_split()`](mini-align.qmd#minialign.gen_step.default_split).

  - `justify` - [`MiniAlign.gen_step.default_justify()`](mini-align.qmd#minialign.gen_step.default_justify).

  - `merge` - [`MiniAlign.gen_step.default_merge()`](mini-align.qmd#minialign.gen_step.default_merge).

---

### align_user() {#minialign.align_user}
...
Will use [`MiniAlign.align_strings()`](mini-align.qmd#minialign.align_strings) and set the following options in `opts`:
...
<span class="help-syntax-special">{action}</span> `(function|table)` Step action. Should be a callable object
  (see [`vim.is_callable()`](https://neovim.io/doc/user/helptag.html?tag=vim.is_callable\(\))).
...
### gen_step.default_split() {#minialign.gen_step.default_split}
...
[`MiniAlign.gen_step.ignore_split()`](mini-align.qmd#minialign.gen_step.ignore_split) heavily uses `split_exclude_patterns`.

---

### gen_step.default_justify() {#minialign.gen_step.default_justify}
...
### gen_step.default_merge() {#minialign.gen_step.default_merge}
...
### gen_step.filter() {#minialign.gen_step.filter}
...
- Group parts with computed mask. See `group()` method of parts in
  [`MiniAlign.as_parts()`](mini-align.qmd#minialign.as_parts).
...
### gen_step.ignore_split() {#minialign.gen_step.ignore_split}
...
[`MiniAlign.gen_step.default_split()`](mini-align.qmd#minialign.gen_step.default_split) for details about
  `split_exclude_patterns` option.

---

### gen_step.pair() {#minialign.gen_step.pair}

<p align="center">`MiniAlign.gen_step.pair`(<span class="help-syntax-special">{direction}</span>)</p>
Generate pair step

Output calls `pair()` method of parts (see [`MiniAlign.as_parts()`](mini-align.qmd#minialign.as_parts)) with
...
### gen_step.trim() {#minialign.gen_step.trim}
...
Output calls `trim()` method of parts (see [`MiniAlign.as_parts()`](mini-align.qmd#minialign.as_parts)) with
