...
- Surrounding is identified by a single character as both "input" (in
  ...
  `add` and `replace` end):
    ...
    - All symbols in brackets '()', '[]', '<span class="help-syntax-special">{}</span>', '<span class="help-syntax-keys">\<\></span>". In "input' represents
...
- Tags are searched using regex-like methods, so issues are inevitable.
  ...
  tags won't match correctly on both ends: '<span class="help-syntax-keys">\<a\></span><span class="help-syntax-keys">\<a\></span><span class="help-syntax-keys">\</a\></span><span class="help-syntax-keys">\</a\></span>'.

#### Setup {#minisurround-setup}
...
#### Example usage {#minisurround-exampleusage}
...
#### Comparisons {#minisurround-comparisons}
...
- [tpope/vim-surround](https://github.com/tpope/vim-surround):
    ...
    - 'mini.surround' supports dot-repeat, customized search path (see
      ...
      queries (see [`MiniSurround.gen_spec.input.treesitter()`](mini-surround.qmd#minisurround.gen_spec.input.treesitter)),
...
- [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround):
    ...
    - 'mini.surround' supports [`[count]`](https://neovim.io/doc/user/helptag.html?tag=[count]) in both input and output
...
#### Highlight groups {#minisurround-highlightgroups}
...
#### Disabling {#minisurround-disabling}
...
### Builtin surroundings {#minisurround-builtin-surroundings}
...
### Glossary {#minisurround-glossary}
...
### Surrounding specification {#minisurround-surrounding-specification}
    ...
    - If specification itself is a callable, it will be called without
      arguments and should return one of:
        ...
        - Array of region pairs. Useful for incorporating other instruments,
          like treesitter (see [`MiniSurround.gen_spec.input.treesitter()`](mini-surround.qmd#minisurround.gen_spec.input.treesitter)). The
...
See [`MiniSurround.gen_spec`](mini-surround.qmd#minisurround.gen_spec) for function wrappers to create commonly used
...
### Count with actions {#minisurround-count-with-actions}
...
### Search algorithm {#minisurround-search-algorithm}
...
- Function returning surround info at <span class="help-syntax-keys">\<input\></span> or <span class="help-syntax-keys">\<output\></span> fields of
  ...
  function name). Use [`input()`](https://neovim.io/doc/user/helptag.html?tag=input\(\)) or [`MiniSurround.user_input()`](mini-surround.qmd#minisurround.user_input). Return
...
[`MiniSurround.gen_spec`](mini-surround.qmd#minisurround.gen_spec)):
...
### highlight() {#minisurround.highlight}
...
### update_n_lines() {#minisurround.update_n_lines}
...
### user_input() {#minisurround.user_input}
...
### gen_spec {#minisurround.gen_spec}
...
### gen_spec.input.treesitter() {#minisurround.gen_spec.input.treesitter}
...
- [`MiniAi.gen_spec.treesitter()`](mini-ai.qmd#miniai.gen_spec.treesitter) for similar 'mini.ai' generator.
