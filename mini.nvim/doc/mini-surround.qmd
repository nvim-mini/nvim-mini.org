...
- Function returning surround info at <span class="help-syntax-keys">\<input\></span> or <span class="help-syntax-keys">\<output\></span> fields of
  ...
  function name). Use [input()](https://neovim.io/doc/user/helptag.html?tag=input\(\)) or [MiniSurround.user\_input()](mini-surround.qmd#minisurround.user_input). Return
...
- [MiniAi.gen\_spec.treesitter()](mini-ai.qmd#miniai.gen_spec.treesitter) for similar 'mini.ai' generator.
