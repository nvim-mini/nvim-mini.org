...
- Mocking methods of 'nvim-tree/nvim-web-devicons' for better integrations
  with plugins outside 'mini.nvim'. See [`MiniIcons.mock_nvim_web_devicons()`](mini-icons.qmd#miniicons.mock_nvim_web_devicons).


- Tweaking built-in maps for "LSP kind" to include icons. In particular, this
  makes [`mini.completion`](mini-completion.qmd#mini.completion) use icons in LSP step. See [`MiniIcons.tweak_lsp_kind()`](mini-icons.qmd#miniicons.tweak_lsp_kind).
...
#### Dependencies {#miniicons-dependencies}
...
#### Comparisons {#miniicons-comparisons}
...
- [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) (for users):
    ...
    - This module provides [`MiniIcons.mock_nvim_web_devicons()`](mini-icons.qmd#miniicons.mock_nvim_web_devicons) function which
...
#### Highlight groups {#miniicons-highlightgroups}
...
### mock_nvim_web_devicons() {#miniicons.mock_nvim_web_devicons}
...
### tweak_lsp_kind() {#miniicons.tweak_lsp_kind}
