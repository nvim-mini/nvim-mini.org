...
<span class="help-syntax-special">{label}</span> `(string|nil)` Label string. Default: `nil` to ask with [vim.ui.input()](https://neovim.io/doc/user/helptag.html?tag=vim.ui.input\(\)).
