...
This module follows vim's ['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') and ['smartcase'](https://neovim.io/doc/user/helptag.html?tag='smartcase') options. When
['ignorecase'](https://neovim.io/doc/user/helptag.html?tag='ignorecase') is set, f, F, t, T will match case-insensitively. When
['smartcase'](https://neovim.io/doc/user/helptag.html?tag='smartcase') is also set, f, F, t, T will only match lowercase
...
<a name="minijump-hl-groups" href="mini-jump.qmd#minijump-hl-groups"><b>MiniJump-hl-groups</b></a>
