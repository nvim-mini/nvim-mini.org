...
- Does not use [:Man](https://neovim.io/doc/user/helptag.html?tag=:Man). Shows page in the target window.
  Use [MiniPick-actions-choose](mini-pick.qmd#minipick-actions-choose) to split.
