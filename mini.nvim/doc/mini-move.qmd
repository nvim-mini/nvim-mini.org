...
- Provides both mappings and Lua functions for motions. See
  [MiniMove.move\_selection()](mini-move.qmd#minimove.move_selection) and [MiniMove.move\_line()](mini-move.qmd#minimove.move_line).
...
- [matze/vim-move](https://github.com/matze/vim-move):
    ...
    - Doesn't support vertical movement of charwise and blockwise selections.
      While [mini.move](mini-move.qmd#mini.move) does.

    - Doesn't support horizontal movement of current line in favor of
      horizontal movement of current character. While [mini.move](mini-move.qmd#mini.move) supports
    ...
    - Has extra functionality for certain moves (like move by half page).
      While [mini.move](mini-move.qmd#mini.move) does not (by design).
...
- [booperlv/nvim-gomove](https://github.com/booperlv/nvim-gomove):
    ...
    - Has extra functionality beyond moving text, like duplication.
      While [mini.move](mini-move.qmd#mini.move) concentrates only on moving functionality.
...
- Vertical movement in linewise mode is followed up by reindent with [v\_=](https://neovim.io/doc/user/helptag.html?tag=v_=).

- Horizontal movement in linewise mode is same as [v\_<](https://neovim.io/doc/user/helptag.html?tag=v_<) and [v\_>](https://neovim.io/doc/user/helptag.html?tag=v_>).
...
- Vertical movement is followed up by reindent with [v\_=](https://neovim.io/doc/user/helptag.html?tag=v_=).
