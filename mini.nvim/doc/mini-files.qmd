...
#### Dependencies {#minifiles-dependencies}
...
#### Comparisons {#minifiles-comparisons}
...
#### Highlight groups {#minifiles-highlightgroups}
...
### Navigation {#minifiles-navigation}
...
### Manipulation {#minifiles-manipulation}
...
(see [`nvim_create_autocmd()`](https://neovim.io/doc/user/helptag.html?tag=nvim_create_autocmd\(\))) with the following information:
...
Combine [`MiniFiles.get_explorer_state()`](mini-files.qmd#minifiles.get_explorer_state) and [`MiniFiles.set_target_window()`](mini-files.qmd#minifiles.set_target_window):
...
Use [`MiniFiles.get_fs_entry()`](mini-files.qmd#minifiles.get_fs_entry):
...
Use [`MiniFiles.set_bookmark()`](mini-files.qmd#minifiles.set_bookmark) inside `MiniFilesExplorerOpen` event:
...
Uses [`MiniFiles.default_filter()`](mini-files.qmd#minifiles.default_filter) by default.
...
Uses [`MiniFiles.default_prefix()`](mini-files.qmd#minifiles.default_prefix) by default.
...
Uses [`MiniFiles.default_sort()`](mini-files.qmd#minifiles.default_sort) by default.
...
### synchronize() {#minifiles.synchronize}
...
### trim_right() {#minifiles.trim_right}
...
### reveal_cwd() {#minifiles.reveal_cwd}
...
### get_fs_entry() {#minifiles.get_fs_entry}
...
### get_explorer_state() {#minifiles.get_explorer_state}
...
`(table|nil)` Table with explorer state data or `nil` if no active explorer.
  ...
  - <span class="help-syntax-keys">\<bookmarks\></span> `(table)` - map from bookmark id (single character) to its data:
    table with <span class="help-syntax-keys">\<path\></span> and <span class="help-syntax-keys">\<desc\></span> fields (see [`MiniFiles.set_bookmark()`](mini-files.qmd#minifiles.set_bookmark)).
...
- [`MiniFiles.set_bookmark()`](mini-files.qmd#minifiles.set_bookmark)

- [`MiniFiles.set_branch()`](mini-files.qmd#minifiles.set_branch)

- [`MiniFiles.set_target_window()`](mini-files.qmd#minifiles.set_target_window)

---

### set_target_window() {#minifiles.set_target_window}
...
### set_branch() {#minifiles.set_branch}
...
[`MiniFiles.get_explorer_state()`](mini-files.qmd#minifiles.get_explorer_state)

---

### set_bookmark() {#minifiles.set_bookmark}
...
### get_latest_path() {#minifiles.get_latest_path}
...
### default_filter() {#minifiles.default_filter}
...
### default_prefix() {#minifiles.default_prefix}
...
### default_sort() {#minifiles.default_sort}
