...
Read, write, and delete sessions. Uses [:mksession](https://neovim.io/doc/user/helptag.html?tag=:mksession) (meaning ['sessionoptions'](https://neovim.io/doc/user/helptag.html?tag='sessionoptions')
...
### restart() {#minisessions.restart .help-syntax-right-anchor}

<p align="center">`MiniSessions.restart`()</p>
Restart Neovim preserving current session

Write (active or new temporary) session, [:restart](https://neovim.io/doc/user/helptag.html?tag=:restart) without preserving
a session, source the session.
On Neovim>=0.12.5 consider using [:restart](https://neovim.io/doc/user/helptag.html?tag=:restart) directly.

Notes:

- Requires Neovim>=0.12 for [:restart](https://neovim.io/doc/user/helptag.html?tag=:restart) command.

- If there is no active session ([v:this\_session](https://neovim.io/doc/user/helptag.html?tag=v:this_session)), [argument-list](https://neovim.io/doc/user/helptag.html?tag=argument-list) is cleared
