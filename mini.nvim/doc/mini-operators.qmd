...
<a name="minioperators-hl-groups" href="mini-operators.qmd#minioperators-hl-groups"><b>MiniOperators-hl-groups</b></a>
...
- If `mode` is "char", "line", or "block", it acts as `operatorfunc` and performs
  action for region between [\`\[](https://neovim.io/doc/user/helptag.html?tag=`[) and [\`\]](https://neovim.io/doc/user/helptag.html?tag=`]) marks.


- If `mode` is "visual", it performs action for region between [\`<](https://neovim.io/doc/user/helptag.html?tag=`<) and [\`>](https://neovim.io/doc/user/helptag.html?tag=`>) marks.
