...
| Command line tweaks | [mini.cmdline](mini-cmdline.qmd#mini.cmdline) |
...
| Get user input | [mini.input](mini-input.qmd#mini.input) |
...
| Statuscolumn | [mini.statuscolumn](mini-statuscolumn.qmd#mini.statuscolumn) |
...
- [mini.cmdline](mini-cmdline.qmd#mini.cmdline) - command line tweaks. Adds autocompletion with customizable
...
- [mini.deps](mini-deps.qmd#mini.deps) - plugin manager for plugins outside of [mini.nvim](mini-nvim.qmd#mini.nvim). Uses Git and
...
- [mini.extra](mini-extra.qmd#mini.extra) - extra mini.nvim functionality. Contains [mini.pick](mini-pick.qmd#mini.pick) pickers,
  [mini.ai](mini-ai.qmd#mini.ai) textobjects, and more.
...
- [mini.input](mini-input.qmd#mini.input) - get user input with fully customizable key and view handling.
  Can show as floating window, statusline/tabline/winbar, virtual line/text.
  Provides [vim.ui.input()](https://neovim.io/doc/user/helptag.html?tag=vim.ui.input\(\)) implementation.
...
- [mini.statuscolumn](mini-statuscolumn.qmd#mini.statuscolumn) - fast ['statuscolumn'](https://neovim.io/doc/user/helptag.html?tag='statuscolumn') with improved defaults, fully
  customizable content, and automatic dimming inside inactive windows.
...
- [mini.tabline](mini-tabline.qmd#mini.tabline) - minimal tabline which always shows listed (see ['buflisted'](https://neovim.io/doc/user/helptag.html?tag='buflisted'))
...
Note: in this section disabling [mini.animate](mini-animate.qmd#mini.animate) is used as example;
