...
### Table of contents {#mini.nvim-table-of-contents}
...
[`nvim_set_hl()`](https://neovim.io/doc/user/helptag.html?tag=nvim_set_hl\(\)) Lua function to customize highlighting. To see a more
calibrated look, use [`mini.hues`](mini-hues.qmd#mini.hues), [`MiniBase16`](mini-base16.qmd#minibase16), or plugin's colorschemes.
...
- [`MiniBase16`](mini-base16.qmd#minibase16) - fast implementation of base16 theme for manually supplied
...
- [`MiniJump2d`](mini-jump2d.qmd#minijump2d) - minimal and fast Lua plugin for jumping (moving cursor)
...
### Color schemes {#mini.nvim-color-schemes}
