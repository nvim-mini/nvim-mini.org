...
- Manage snippet collection by adding it explicitly or with a flexible set of
  performant built-in loaders. See [`MiniSnippets.gen_loader`](mini-snippets.qmd#minisnippets.gen_loader).
...
- Configured snippets are efficiently resolved before every expand based on
  ...
  See [`MiniSnippets.default_prepare()`](mini-snippets.qmd#minisnippets.default_prepare).


- Match which snippet to insert based on the currently typed text.
  Supports both exact and fuzzy matching. See [`MiniSnippets.default_match()`](mini-snippets.qmd#minisnippets.default_match).


- Select from several matched snippets via `vim.ui.select()`.
  See [`MiniSnippets.default_select()`](mini-snippets.qmd#minisnippets.default_select).
...
- Start specialized in-process LSP server to show loaded snippets inside
  ...
  See [`MiniSnippets.start_lsp_server()`](mini-snippets.qmd#minisnippets.start_lsp_server).
...
- Insert, jump, and edit during snippet session in a configurable manner:
  ...
  See [`MiniSnippets.default_insert()`](mini-snippets.qmd#minisnippets.default_insert).
...
#### Dependencies {#minisnippets-dependencies}
...
#### Comparisons {#minisnippets-comparisons}
...
#### Highlight groups {#minisnippets-highlightgroups}
...
#### Disabling {#minisnippets-disabling}
...
### Glossary {#minisnippets-glossary}
...
### Overview {#minisnippets-overview}
...
- Variable `TM_SELECTED_TEXT` is resolved as contents of [`quote_quote`](https://neovim.io/doc/user/helptag.html?tag=quote_quote) register.
...
- [`MiniSnippets.default_prepare()`](mini-snippets.qmd#minisnippets.default_prepare)

- [`MiniSnippets.default_match()`](mini-snippets.qmd#minisnippets.default_match)

- [`MiniSnippets.default_select()`](mini-snippets.qmd#minisnippets.default_select)

- [`MiniSnippets.default_insert()`](mini-snippets.qmd#minisnippets.default_insert)
...
call [`MiniSnippets.start_lsp_server()`](mini-snippets.qmd#minisnippets.start_lsp_server) after [`MiniSnippets.setup()`](mini-snippets.qmd#minisnippets.setup). This sets up
...
- Put files in "snippets" subdirectory of any path in 'runtimepath' (like
  ...
  This is compatible with [`MiniSnippets.gen_loader.from_runtime()`](mini-snippets.qmd#minisnippets.gen_loader.from_runtime) and
...
### Examples {#minisnippets-examples}
...
language (see [`MiniSnippets.gen_loader.from_lang()`](mini-snippets.qmd#minisnippets.gen_loader.from_lang)).
...
Note: all built-in loaders and [`MiniSnippets.read_file()`](mini-snippets.qmd#minisnippets.read_file) cache their output
by default. It means that after a file is first read, changing it won't have
effect during current Neovim session. See [`MiniSnippets.gen_loader`](mini-snippets.qmd#minisnippets.gen_loader) about how
...
With [`MiniSnippets.default_match()`](mini-snippets.qmd#minisnippets.default_match), expand snippets (<span class="help-syntax-keys">\<C-j\></span> by default) at line
...
See [`MiniSnippets.default_prepare()`](mini-snippets.qmd#minisnippets.default_prepare) for how it is done by default.
...
the duration of active snippet session(s) from [`MiniSnippets.default_insert()`](mini-snippets.qmd#minisnippets.default_insert).
...
Default: [`MiniSnippets.default_prepare()`](mini-snippets.qmd#minisnippets.default_prepare).
...
Default: [`MiniSnippets.default_match()`](mini-snippets.qmd#minisnippets.default_match)
...
Default: [`MiniSnippets.default_select()`](mini-snippets.qmd#minisnippets.default_select)
...
Default: [`MiniSnippets.default_insert()`](mini-snippets.qmd#minisnippets.default_insert)
...
[`MiniSnippets.start_lsp_server()`](mini-snippets.qmd#minisnippets.start_lsp_server) to instead show loaded snippets
  in (auto)completion engines (like [`mini.completion`](mini-completion.qmd#mini.completion)).

---

### gen_loader {#minisnippets.gen_loader}
...
### gen_loader.from_lang() {#minisnippets.gen_loader.from_lang}
...
See [`MiniSnippets.gen_loader.from_runtime()`](mini-snippets.qmd#minisnippets.gen_loader.from_runtime) for runtime loading details.
...
This is compatible with [`MiniSnippets.default_prepare()`](mini-snippets.qmd#minisnippets.default_prepare) and most snippet
collection plugins.
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible values:
  ...
  - <span class="help-syntax-keys">\<lang_patterns\></span> `(table)` - map from language to array of runtime patterns
    used to find snippet files, as in [`MiniSnippets.gen_loader.from_runtime()`](mini-snippets.qmd#minisnippets.gen_loader.from_runtime).
    Patterns will be processed in order. With [`MiniSnippets.default_prepare()`](mini-snippets.qmd#minisnippets.default_prepare)
...
### gen_loader.from_runtime() {#minisnippets.gen_loader.from_runtime}
...
<span class="help-syntax-special">{pattern}</span> `(string)` Pattern of files to read. Can have wildcards as described
  in [`nvim_get_runtime_file()`](https://neovim.io/doc/user/helptag.html?tag=nvim_get_runtime_file\(\)). Example for "lua" language: `'lua.{json,lua}'`.
...
### gen_loader.from_file() {#minisnippets.gen_loader.from_file}
...
Output is a thin wrapper around [`MiniSnippets.read_file()`](mini-snippets.qmd#minisnippets.read_file) which will skip
...
<span class="help-syntax-special">{path}</span> `(string)` Same as in [`MiniSnippets.read_file()`](mini-snippets.qmd#minisnippets.read_file).

<span class="help-syntax-special">{opts}</span> `(table|nil)` Same as in [`MiniSnippets.read_file()`](mini-snippets.qmd#minisnippets.read_file).
...
### read_file() {#minisnippets.read_file}
...
### default_prepare() {#minisnippets.default_prepare}
...
Unlike [`MiniSnippets.gen_loader`](mini-snippets.qmd#minisnippets.gen_loader) entries, there is no output caching. This
...
### default_match() {#minisnippets.default_match}
...
### default_select() {#minisnippets.default_select}
...
This is the case for at least [`MiniPick.ui_select()`](mini-pick.qmd#minipick.ui_select) and Neovim's default.
...
### default_insert() {#minisnippets.default_insert}
...
- If tabstop has choices, all of them are shown after each jump and deleting
  ...
  delete whole tabstop text (for example with one or more [`i_CTRL-W`](https://neovim.io/doc/user/helptag.html?tag=i_CTRL-W)) for
...
### session {#minisnippets.session}

<p align="center">`MiniSnippets.session`</p>
Work with snippet session from [`MiniSnippets.default_insert()`](mini-snippets.qmd#minisnippets.default_insert)

---

### session.get() {#minisnippets.session.get}
...
`(table)` Single table with session data (if `all` is `false`) or array of them.
  Session data contains the following fields:
   ...
   - <span class="help-syntax-keys">\<insert_args\></span> `(table)` - [`MiniSnippets.default_insert()`](mini-snippets.qmd#minisnippets.default_insert) arguments used to
...
### session.jump() {#minisnippets.session.jump}
...
### session.stop() {#minisnippets.session.stop}
...
### start_lsp_server() {#minisnippets.start_lsp_server}
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<match\></span> `(false|function)` - value of `opts.match` forwarded to
    ...
    Default: `nil` (equivalent to [`MiniSnippets.default_match()`](mini-snippets.qmd#minisnippets.default_match)).
