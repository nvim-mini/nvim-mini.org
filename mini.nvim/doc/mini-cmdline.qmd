...
- Customization of command line UI. Use [ui2](https://neovim.io/doc/user/helptag.html?tag=ui2) (on Neovim>=0.12).
...
- Built-in [ui2](https://neovim.io/doc/user/helptag.html?tag=ui2) (on Neovim>=0.12):
