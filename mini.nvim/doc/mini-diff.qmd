...
Default: 60. See [vim.text.diff()](https://neovim.io/doc/user/helptag.html?tag=vim.text.diff\(\)) ([vim.diff()](https://neovim.io/doc/user/helptag.html?tag=vim.diff\(\)) on Neovim<=0.11) and 'diffopt'
for more details.
