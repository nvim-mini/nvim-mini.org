...
<a name="minidiff-hl-groups" href="mini-diff.qmd#minidiff-hl-groups"><b>MiniDiff-hl-groups</b></a>
...
- To work with BOM bytes, set ['bomb'](https://neovim.io/doc/user/helptag.html?tag='bomb') and have `ucs-bom` in ['fileencodings'](https://neovim.io/doc/user/helptag.html?tag='fileencodings').
...
Default: "histogram". See [vim.text.diff()](https://neovim.io/doc/user/helptag.html?tag=vim.text.diff\(\)) ([vim.diff()](https://neovim.io/doc/user/helptag.html?tag=vim.diff\(\)) on Neovim<=0.11)
for possible values.
...
Default: 60. See [vim.text.diff()](https://neovim.io/doc/user/helptag.html?tag=vim.text.diff\(\)) ([vim.diff()](https://neovim.io/doc/user/helptag.html?tag=vim.diff\(\)) on Neovim<=0.11) and ['diffopt'](https://neovim.io/doc/user/helptag.html?tag='diffopt')
for more details.
...
<span class="help-syntax-special">{text}</span> `(string|table|nil)` New reference text. Default: `nil`. Can be:
