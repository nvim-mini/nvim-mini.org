...
- "Word under cursor" is meant as in Vim's [`<cword>`](https://neovim.io/doc/user/helptag.html?tag=<cword>): something user would
  get as 'iw' text object.

#### Setup {#minicursorword-setup}
...
#### Highlight groups {#minicursorword-highlightgroups}
...
#### Disabling {#minicursorword-disabling}
