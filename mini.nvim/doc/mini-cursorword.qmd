...
- "Word under cursor" is meant as in Vim's [<span class="help-syntax-keys">\<cword\></span>](https://neovim.io/doc/user/helptag.html?tag=<cword>): something user would
  get as [iw](https://neovim.io/doc/user/helptag.html?tag=iw) text object.
...
<a name="minicursorword-hl-groups" href="mini-cursorword.qmd#minicursorword-hl-groups"><b>MiniCursorword-hl-groups</b></a>
