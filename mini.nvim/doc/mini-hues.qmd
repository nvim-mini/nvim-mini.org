...
- Random generator for base colors. See [`MiniHues.gen_random_base_colors()`](mini-hues.qmd#minihues.gen_random_base_colors).
  Powers [`randomhue`](mini-hues.qmd#randomhue) color scheme.


- Lua function to compute palette used in color scheme.
  See [`MiniHues.make_palette()`](mini-hues.qmd#minihues.make_palette).
...
- This module doesn't define [`cterm-colors`](https://neovim.io/doc/user/helptag.html?tag=cterm-colors) for implementation simplicity.
  Use [`mini.colors`](mini-colors.qmd#mini.colors) module, [`MiniColors-colorscheme:add_cterm_attributes()`](mini-colors.qmd#minicolors-colorschemeadd_cterm_attributes)
  in particular.

---

### Color schemes {#minihues-color-schemes}
...
- <a name="randomhue" href="mini-hues.qmd#randomhue"><b>randomhue</b></a> : uses randomly generated same hue background and foreground.
  ...
  [`MiniHues.gen_random_base_colors()`](mini-hues.qmd#minihues.gen_random_base_colors) with a slight adjustments for
  'background' value.
...
of [`MiniHues.make_palette()`](mini-hues.qmd#minihues.make_palette) and [`MiniHues.apply_palette()`](mini-hues.qmd#minihues.apply_palette).
...
See [`MiniHues.make_palette()`](mini-hues.qmd#minihues.make_palette) for more information about how certain settings
...
### make_palette() {#minihues.make_palette}
...
[`MiniHues.get_palette()`](mini-hues.qmd#minihues.get_palette)

---

### apply_palette() {#minihues.apply_palette}

<p align="center">`MiniHues.apply_palette`(<span class="help-syntax-special">{palette}</span>, <span class="help-syntax-special">{plugins}</span>)</p>
Apply palette
...
<span class="help-syntax-special">{palette}</span> `(table)` Table with structure as [`MiniHues.make_palette()`](mini-hues.qmd#minihues.make_palette) output.
...
### get_palette() {#minihues.get_palette}
...
`(table)` Table with structure as [`MiniHues.make_palette()`](mini-hues.qmd#minihues.make_palette) output that was
  the latest applied (via [`MiniHues.apply_palette()`](mini-hues.qmd#minihues.apply_palette)) palette.

---

### gen_random_base_colors() {#minihues.gen_random_base_colors}
