...
#### Comparisons {#minibasics-comparisons}
...
- General:
    ...
    - Sets [`<Leader>`](https://neovim.io/doc/user/helptag.html?tag=<Leader>) key to [`<Space>`](https://neovim.io/doc/user/helptag.html?tag=<Space>). Be sure to make all Leader mappings
...
- On Neovim>=0.10 mappings for `#` and `*` are not created as their
  enhanced variants are made built-in. See [`v_star-default`](https://neovim.io/doc/user/helptag.html?tag=v_star-default) and [`v_#-default`](https://neovim.io/doc/user/helptag.html?tag=v_#-default).

- On Neovim>=0.11 there are [`[<Space>`](https://neovim.io/doc/user/helptag.html?tag=[<Space>) / [`]<Space>`](https://neovim.io/doc/user/helptag.html?tag=]<span class="help-syntax-keys">\<Space\></span>) for adding empty lines.
...
- Something with [`<Leader>`](https://neovim.io/doc/user/helptag.html?tag=<Leader>) key, like `<Leader>t` (`t` for "toggle"). Note:
...
- Window navigation:
    ...
    - `<C-h>` - focus on left window (see [`CTRL-W_H`](https://neovim.io/doc/user/helptag.html?tag=CTRL-W_H)).

    - `<C-j>` - focus on below window (see [`CTRL-W_J`](https://neovim.io/doc/user/helptag.html?tag=CTRL-W_J)).

    - `<C-k>` - focus on above window (see [`CTRL-W_K`](https://neovim.io/doc/user/helptag.html?tag=CTRL-W_K)).

    - `<C-l>` - focus on right window (see [`CTRL-W_L`](https://neovim.io/doc/user/helptag.html?tag=CTRL-W_L)).
...
- Highlights yanked text for a brief period of time (see [`vim.hl.on_yank()`](https://neovim.io/doc/user/helptag.html?tag=vim.hl.on_yank\(\));
  on Neovim<0.11 - [`vim.hl.on_yank()`](https://neovim.io/doc/user/helptag.html?tag=vim.hl.on_yank\(\))) and [`TextYankPost`](https://neovim.io/doc/user/helptag.html?tag=TextYankPost)).
...
### toggle_diagnostic() {#minibasics.toggle_diagnostic}
