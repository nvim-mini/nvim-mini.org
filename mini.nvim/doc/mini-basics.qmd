...
- The <span class="help-syntax-keys">\<C-c\></span> mapping is basically a combination of [CTRL-C](https://neovim.io/doc/user/helptag.html?tag=CTRL-C) and [CTRL-L-default](https://neovim.io/doc/user/helptag.html?tag=CTRL-L-default).
  This combines related actions under one mapping. Particularly useful with
  enabled `mappings.windows` as it overrides [CTRL-L-default](https://neovim.io/doc/user/helptag.html?tag=CTRL-L-default).

- On Neovim>=0.11 there are [\[<span class="help-syntax-keys">\<Space\></span>](https://neovim.io/doc/user/helptag.html?tag=[<Space>) / [\]<span class="help-syntax-keys">\<Space\></span>](https://neovim.io/doc/user/helptag.html?tag=]<Space>) for adding empty lines.
...
- Window navigation:
    ...
    - `<C-l>` - focus on right window (see [CTRL-W\_L](https://neovim.io/doc/user/helptag.html?tag=CTRL-W_L)).
      Note: this overrides [CTRL-L-default](https://neovim.io/doc/user/helptag.html?tag=CTRL-L-default). Use <span class="help-syntax-keys">\<C-c\></span> set up in `mappings.basic`.
...
- Highlights yanked text for a brief period of time. See [vim.hl.on\_yank()](https://neovim.io/doc/user/helptag.html?tag=vim.hl.on_yank\(\))
  (which is [vim.hl.hl\_op()](https://neovim.io/doc/user/helptag.html?tag=vim.hl.hl_op\(\)) on Neovim>=0.13 and [vim.highlight.on\_yank()](https://neovim.io/doc/user/helptag.html?tag=vim.highlight.on_yank\(\))
  on Neovim<0.11) and [TextYankPost](https://neovim.io/doc/user/helptag.html?tag=TextYankPost).
