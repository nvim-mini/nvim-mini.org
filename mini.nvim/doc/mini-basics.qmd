...
- Highlights yanked text for a brief period of time. See [vim.hl.on\_yank()](https://neovim.io/doc/user/helptag.html?tag=vim.hl.on_yank\(\))
  (which is [vim.highlight.on\_yank()](https://neovim.io/doc/user/helptag.html?tag=vim.highlight.on_yank\(\)) on Neovim<0.11) and [TextYankPost](https://neovim.io/doc/user/helptag.html?tag=TextYankPost).
