...
- Truncation symbols which show if there are tabs to the left and/or right.
  Exact characters are taken from ['listchars'](https://neovim.io/doc/user/helptag.html?tag='listchars') global value (`precedes` and
  `extends` fields) and are shown only if ['list'](https://neovim.io/doc/user/helptag.html?tag='list') option is enabled.
...
- ['showtabline'](https://neovim.io/doc/user/helptag.html?tag='showtabline') is set to 2 to always show tabline.

#### Highlight groups {#module-highlightgroups}


<a name="minitabline-hl-groups" href="mini-tabline.qmd#minitabline-hl-groups"><b>MiniTabline-hl-groups</b></a>
...
treated strictly as text (i.e. no ['statusline'](https://neovim.io/doc/user/helptag.html?tag='statusline') like constructs is allowed).
This function will be called for all displayable in tabline buffers.
Default: [MiniTabline.default\_format()](mini-tabline.qmd#minitabline.default_format).
