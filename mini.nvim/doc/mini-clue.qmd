...
- Implement custom key query process to reach target key combination:
    ...
    - Each key press narrows down set of possible targets.
      ...
      Doesn't depend on ['timeoutlen'](https://neovim.io/doc/user/helptag.html?tag='timeoutlen') and has basic support for ['langmap'](https://neovim.io/doc/user/helptag.html?tag='langmap').
...
<a name="miniclue-hl-groups" href="mini-clue.qmd#miniclue-hl-groups"><b>MiniClue-hl-groups</b></a>
...
- Allow reaching certain mappings be independent of ['timeoutlen'](https://neovim.io/doc/user/helptag.html?tag='timeoutlen'). That is,
...
- Enable automated showing of next key clues after user-supplied delay
  (also independent of ['timeoutlen'](https://neovim.io/doc/user/helptag.html?tag='timeoutlen')).
...
- Key query process starts when user types a trigger: certain keys in certain
  ...
  two keys, they should be pressed within ['timeoutlen'](https://neovim.io/doc/user/helptag.html?tag='timeoutlen') milliseconds.
...
By default triggers are automatically created in listed (['buflisted'](https://neovim.io/doc/user/helptag.html?tag='buflisted')) and some
...
- <span class="help-syntax-keys">\<mode\></span> `(string|table)` - single character describing mode short-name of
...
don't add [g'](https://neovim.io/doc/user/helptag.html?tag=g') and [g\`](https://neovim.io/doc/user/helptag.html?tag=g`) as triggers: they already will be taken into account.
