...
- Infer data about color scheme and/or modify based on it:
    ...
    - Infer cterm attributes ([cterm-colors](https://neovim.io/doc/user/helptag.html?tag=cterm-colors)) based on gui colors making it
      compatible with ['notermguicolors'](https://neovim.io/doc/user/helptag.html?tag='notermguicolors').
...
- [rktjmp/lush.nvim](https://github.com/rktjmp/lush.nvim):
    ...
    - Oriented towards tweaking separate highlight groups, while [mini.colors](mini-colors.qmd#mini.colors)
      is more designed to work with color scheme as a whole.

    - Uses HSL and HSLuv color spaces, while [mini.colors](mini-colors.qmd#mini.colors) uses Oklab, Oklch,
    ...
    - Doesn't have functionality to infer and repair missing data in color
      ...
      while [mini.colors](mini-colors.qmd#mini.colors) does.

    - Doesn't implement animation of color scheme transition, while
      [mini.colors](mini-colors.qmd#mini.colors) does.
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields can be used to configure which
  ...
  - <span class="help-syntax-keys">\<statuscolumn\></span> `(boolean)` - groups related to ['statuscolumn'](https://neovim.io/doc/user/helptag.html?tag='statuscolumn') (signcolumn,
  ...
  - <span class="help-syntax-keys">\<statusline\></span> `(boolean)` - built-in groups for ['statusline'](https://neovim.io/doc/user/helptag.html?tag='statusline'). Default: `false`.

  - <span class="help-syntax-keys">\<tabline\></span> `(boolean)` - built-in groups for ['tabline'](https://neovim.io/doc/user/helptag.html?tag='tabline'). Default: `false`.

  - <span class="help-syntax-keys">\<winbar\></span> `(boolean)` - built-in groups for ['winbar'](https://neovim.io/doc/user/helptag.html?tag='winbar'). Default: `false`.
