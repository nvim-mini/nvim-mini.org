...
- Create colorscheme object: either manually ([`MiniColors.as_colorscheme()`](mini-colors.qmd#minicolors.as_colorscheme))
  or by querying present color schemes (including currently active one; see
  [`MiniColors.get_colorscheme()`](mini-colors.qmd#minicolors.get_colorscheme)).
...
#### Tweak quick start {#minicolors-tweakquickstart}
...
#### Comparisons {#minicolors-comparisons}
...
- For color scheme creators use [`MiniColors-colorscheme:simulate_cvd()`](mini-colors.qmd#minicolors-colorschemesimulate_cvd) to
  simulate various color vision deficiency types to see how color scheme
  would look in the eyes of color blind person.

---

### Color spaces {#minicolors-color-spaces}
...
### Colorscheme {#minicolors-colorscheme}
...
Create colorscheme object manually with [`MiniColors.as_colorscheme()`](mini-colors.qmd#minicolors.as_colorscheme):
...
object with [`MiniColors.get_colorscheme()`](mini-colors.qmd#minicolors.get_colorscheme):
...
<span class="help-syntax-special">{name}</span> `(string|nil)` Name of the color scheme (as in [`g:colors_name`](https://neovim.io/doc/user/helptag.html?tag=g:colors_name)).


<span class="help-syntax-special">{groups}</span> `(table|nil)` Table with highlight groups data. Keys are group
  names appropriate for `name` argument of [`nvim_set_hl()`](https://neovim.io/doc/user/helptag.html?tag=nvim_set_hl\(\)), values - tables
...
<span class="help-syntax-special">{terminal}</span> `(table|nil)` Table with terminal colors data ([`terminal-config`](https://neovim.io/doc/user/helptag.html?tag=terminal-config)).
  ...
  string or plain color name; see [`nvim_get_color_by_name()`](https://neovim.io/doc/user/helptag.html?tag=nvim_get_color_by_name\(\))).
...
(see [`MiniColors-colorscheme:get_palette()`](mini-colors.qmd#minicolors-colorschemeget_palette)). It updates `terminal` field
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<palette_args\></span> `(table)` - [`MiniColors-colorscheme:get_palette()`](mini-colors.qmd#minicolors-colorschemeget_palette) arguments.
...
- Set [`g:colors_name`](https://neovim.io/doc/user/helptag.html?tag=g:colors_name) to a `name` field.
...
<span class="help-syntax-special">{opts}</span> `(table|nil)` Options. Possible fields:
  ...
  - <span class="help-syntax-keys">\<filter\></span> `(function|string)` - filter colors to update. Possible values:
      ...
      - Callable with signature as in [`MiniColors-colorscheme:color_modify()`](mini-colors.qmd#minicolors-colorschemecolor_modify).
...
and [`MiniColors-colorscheme:resolve_links()`](mini-colors.qmd#minicolors-colorschemeresolve_links) before applying this.
...
a wrapper using [`MiniColors.simulate_cvd()`](mini-colors.qmd#minicolors.simulate_cvd) as a part of
call to [`MiniColors-colorscheme:color_modify()`](mini-colors.qmd#minicolors-colorschemecolor_modify) method.
...
[`:hi-clear`](https://neovim.io/doc/user/helptag.html?tag=:hi-clear) call followed by a series of [`nvim_set_hl()`](https://neovim.io/doc/user/helptag.html?tag=nvim_set_hl\(\)) calls.
...
- If colors were updated, it is usually a good idea to infer cterm attributes
  with [`MiniColors-colorscheme:add_cterm_attributes()`](mini-colors.qmd#minicolors-colorschemeadd_cterm_attributes) prior to writing.
...
### as_colorscheme() {#minicolors.as_colorscheme}
...
### get_colorscheme() {#minicolors.get_colorscheme}
...
<span class="help-syntax-special">{name}</span> `(string|nil)` Name of color scheme to use. If `nil` (default) creates
 colorscheme object based on currently active data ([`g:colors_name`](https://neovim.io/doc/user/helptag.html?tag=g:colors_name),
...
### interactive() {#minicolors.interactive}
...
### modify_channel() {#minicolors.modify_channel}
...
### simulate_cvd() {#minicolors.simulate_cvd}
