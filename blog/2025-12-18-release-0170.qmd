...
The 'mini.nvim' plugin has released a new 0.17.0 version. The previous release was a whopping 7 months and 235 commits ago. It is long overdue, to say the least.
...
One of the big reasons why this release took so much more time than previous ones was that there was a lot of adjacent work:

- The whole project was rebranded to be MINI: Modular Independent Neovim Improvements.

- There is now a website, from which you are reading. It took a lot of time to plan and execute.
...
- There is now an amazing [team](https://github.com/orgs/nvim-mini/people) that helps me with MINI. It is very important to me to improve the bus factor of the project to improve its longevity.
...
The other big reason for a big release delay was that in July my initial PR for the Neovim's built-in plugin manager (`vim.pack`) got merged. Its core ideas come from 'mini.deps' with some adjustments and overall improvements. It required a lot of time and effort to address initial issues and discussions.

---

The full changelog for 0.17 is [here](/mini.nvim/CHANGELOG.html#v0.17.0). Here are some hand picked visible changes:

- There are now a set of 'mini.hues' based color schemes. They are inspired by four seasons: `miniwinter`, `minispring`, `minisummer`, `miniautumn`.

- 'mini.ai' and 'mini.surround' tree-sitter integrations now don't use 'nvim-treesitter' function by default in favor of built-in `vim.treesitter` ones.
...
Huge thank you for the continued support of 'mini.nvim' project! We are past 7.2K stars now 🌟❤️
