---
title: "Difference between configs `nvim-0.10` and `nvim-0.11`"
---

_Generated from the `main` branch of 'MiniMax'_

### Difference between configs `nvim-0.10` and `nvim-0.11`

This page shows changes when moving from config [`nvim-0.10`](../../nvim-0.10/index.qmd) to config [`nvim-0.11`](../../nvim-0.11/index.qmd).
They are broken down into per-file differences that are shown in [unified `diff` format](https://en.wikipedia.org/wiki/Diff#Unified_format).
